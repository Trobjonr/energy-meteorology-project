...
# ==========================================================
# 2. TIME FILTER (TRANSITION PHASE > 09:22 CDT)
# ==========================================================
...
if min_hr >= 12:
    ...
    # 09:22 CDT = 14:22 UTC
    START_HOUR, START_MIN = 14, 22 
else:
    print("  -> Detected Local Time (CDT).")
    # 09:22 CDT
    START_HOUR, START_MIN = 9, 22

start_time = datetime.time(START_HOUR, START_MIN, 0)
print(f"Applying Time Filter: Keeping data AFTER {start_time} (Transition Phase)...")
...
if results:
    ...
    plt.title(f"Wake Recovery: Sept 14 (> 09:22 CDT)\nLocalized Reference Method", fontweight='bold')
    ...
    out_name = "Armadillo_Recovery_Sept14_PostTransition_Localized.png"
