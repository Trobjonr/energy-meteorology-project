...
# 1. Target File: Sept 13 (Control Day)
FILES = ["processed_9_13.csv"]
...
print("Loading Armadillo Flats data (Sept 13)...")
df_list = []
for f in FILES:
    if os.path.exists(f):
        tmp = pd.read_csv(f)
...
# ==========================================================
# 2. TIME FILTER (FULL FLIGHT > 13:00 CDT)
# ==========================================================
...
print(f"Applying Time Filter: Keeping data AFTER {start_time} (Full Flight)...")

# Filter for AFTER (>=) the start time
...
if results:
    ...
    plt.title(f"Wake Recovery: Sept 13 (Full Flight)\nLocalized Reference Method", fontweight='bold')
    ...
    out_name = "Armadillo_Recovery_Sept13_Full_Localized.png"
